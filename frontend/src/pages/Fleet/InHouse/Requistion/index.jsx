...
import AddRequistion from "./AddRequistion";
...
const Requistion = () => {
  ...
  const handleEdit = (id) => {
    history.push(`/fleet/requistion/edit/${id}`);
  };
  ...
  return (
    <Fragment>
      ...
      >
        <AddRequistion close={handleClose} refresh={loadRequistion} />
      </FNModal> */}
      {/* <FNModal
        showModal={updateModal}
        handleClose={updateClose}
        lg="lg"
        title="Update Requistion"
      >
