...
const UsersAmount = () => {
    ...
    const loadDays = async () => {
        setLoading(true);
        try {
            const res = await API.get(`/activity/amounts`);
            console.log(res)
            setDays(res?.data);
            setLoading(false);
        } catch (error) {
    ...
    const downloadPDF = () => {
        ...
        doc.text('Participant Total Days and Amount Report', pageWidth / 2, 22, {
            align: 'center'
        });
        ...
        // Table headers
        const headers = [['Name', 'Title', 'Phone', 'Total Days', 'Total Amounts']];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page d-sm-flex align-items-center justify-content-between mb-3">
                        <h4 class="mb-sm-0 font-size-18">Participant Total Days and Amount Report</h4>
