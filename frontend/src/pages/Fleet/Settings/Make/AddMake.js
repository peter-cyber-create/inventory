...
const AddMake = ({ close, refresh }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLoading(false);
            toast.error("Error while Adding Vehicle Make");
        }
    };
            ...
            <div class="card-body">
                <section id="kyc-verify-wizard-p-0" role="tabpanel" aria-labelledby="kyc-verify-wizard-h-0" class="body current" aria-hidden="false">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label for="kycselectcity-input" class="form-label">Vehicle Make Name</label>
                                <input type="text" class="form-control" placeholder="Enter Vehicle Make Name"
                                    value={formData.name}
                                    onChange={(e) =>
                    ...
                    <div className="actions clearfix">
                        <button className="btn btn-primary waves-effect waves-light" onClick={handleSubmit} role="menuitem" style={{ cursor: 'pointer' }}>
                            {loading ? <FNSpinner /> : "Add Vehicle Make"}
                        </button>
                    </div>
                </section>
            </div>
