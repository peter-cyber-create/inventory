...
app.get('/api/assets', (req, res) => {
  res.json([
    { id: 1, assetTag: 'ASSET001', name: 'Desktop Computer', status: 'active' },
    { id: 2, assetTag: 'ASSET002', name: 'Laptop Computer', status: 'active' },
    { id: 3, assetTag: 'ASSET003', name: 'Printer', status: 'maintenance' }
  ]);
});

app.get('/api/vehicles', (req, res) => {
  res.json([
    { id: 1, registrationNumber: 'UAA 123A', make: 'Toyota', model: 'Hilux', status: 'active' },
    { id: 2, registrationNumber: 'UAA 456B', make: 'Ford', model: 'Ranger', status: 'active' }
  ]);
});
